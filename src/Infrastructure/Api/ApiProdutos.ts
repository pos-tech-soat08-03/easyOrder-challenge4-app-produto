...
export class ApiProdutos {
    ...
    static start(produtoGateway: ProdutoGateway, app: Express): void {
        ...
        app.get("/produto/listar", async (req: Request, res: Response) => {
            /**
                #swagger.tags = ['Produtos']
                #swagger.path = '/produto/listar'
                #swagger.method = 'get'
                #swagger.summary = 'Listar Produtos'
                #swagger.description = 'Lista todos os produtos cadastrados<br><br>[ Endpoint para integração aos sistemas administrativo e/ou de loja ]'
        ...
        app.get("/produto/buscar/:id", async (req: Request<{ id: string }>, res: Response) => {
            /**
                #swagger.summary = 'Buscar Produto'
                #swagger.description = 'Busca um produto utilizando o Id.<br><br>[ Endpoint para integração aos sistemas administrativo e/ou de loja ]'
                #swagger.tags = ['Produtos']
        ...
        app.get("/produto/listar/:categoria", async (req: Request<{ categoria: string }>, res: Response) => {
            /**
                #swagger.tags = ['Produtos']
                #swagger.path = '/produto/listar/{categoria}'
                #swagger.method = 'get'
                #swagger.summary = 'Listar Produtos por Categoria'
                #swagger.description = 'Lista produtos por categoria<br><br>[ Endpoint para integração aos sistemas administrativo e/ou de loja ]'
                #swagger.produces = ["application/json"]
                #swagger.security = [{
                    "bearerAuth": []
                }]
        ...
        app.delete("/produto/remover/:id", async (req: Request<{ id: string }>, res: Response) => {
            /**
                #swagger.tags = ['Produtos']
                #swagger.path = '/produto/remover/{id}'
                #swagger.method = 'delete'
                #swagger.summary = 'Remover Produto'
                #swagger.description = 'Remove um produto, por Id.<br><br>[ Endpoint para integração aos sistemas administrativo e/ou de loja ]'
                #swagger.produces = ["application/json"]
                #swagger.security = [{
                    "bearerAuth": []
                }]
        ...
        app.post("/produto/cadastrar", async (req: Request, res: Response) => {
            /**
                #swagger.tags = ['Produtos']
                #swagger.path = '/produto/cadastrar'
                #swagger.method = 'post'
                #swagger.summary = 'Cadastrar Produto'
                #swagger.description = 'Realiza o Cadastro de um Novo Produto, através dos dados fornecidos no corpo da requisição.<br><br>[ Endpoint para integração aos sistemas administrativo e/ou de loja ]'
                #swagger.produces = ["application/json"]  
                #swagger.security = [{
                    "bearerAuth": []
                }]
        ...
        app.put("/produto/atualizar", async (req: Request, res: Response) => {
            /**
                #swagger.tags = ['Produtos']
                #swagger.path = '/produto/atualizar'
                #swagger.method = 'put'
                #swagger.summary = 'Atualizar Produto'
                #swagger.description = 'Atualiza o Cadastro de um Produto, através dos dados fornecidos no corpo da requisição.<br><br>[ Endpoint para integração aos sistemas administrativo e/ou de loja ]'
                #swagger.produces = ["application/json"]  
                #swagger.security = [{
                    "bearerAuth": []
                }]
